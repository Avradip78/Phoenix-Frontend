...
export function HrWorkforcePage() {
  ...
  const data = WORKFORCE_SOLUTIONS.find(s => s.id === 'hr') || WORKFORCE_SOLUTIONS[0];
  ...
  return (
    <div className="pt-28 pb-20 bg-[#07111F] text-slate-200 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Operational Bottleneck vs Proposed Solution */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
          ...
          <div className="p-6 rounded-xl bg-[#0D1B2A] border border-teal-500/40 shadow-xl">
            <span className="text-xs font-bold uppercase tracking-wider text-teal-400 block mb-2 font-mono">
              Proposed AI Workforce Approach
            </span>
            <p className="text-sm text-slate-300 leading-relaxed">
              A coordinated fleet of 10 specialized HR agents handles high-volume discovery, structured screening, and scheduling synchronization, while human recruiters retain sole authority over critical hiring choices.
            </p>
          </div>
        </div>

        {/* Human Oversight / Guardrails (CRITICAL SECTION) */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-white mt-1 mb-2">
                Mandatory Human-in-the-Loop Approval Gates
              </h3>
              <p className="text-sm text-amber-200/90 leading-relaxed mb-4">
                AI agents strictly assist and prepare data—they <strong>never independently make sensitive employment decisions</strong>. The following actions strictly require explicit human manager sign-off:
              </p>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              End-to-End Example Workflow (13 Defined Stages)
            </h3>
          </div>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              10 Specialized HR & Recruitment Agents
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
          <div className="lg:col-span-6 bg-[#0D1B2A] p-6 rounded-2xl border border-[#1E3553] shadow-xl">
            <h4 className="text-sm font-bold uppercase tracking-wider text-white mb-3 flex items-center gap-2 font-mono">
              ...
              Supported HR System Integrations
            </h4>
          ...
          <div className="lg:col-span-6 bg-[#0D1B2A] text-white p-6 rounded-2xl border border-[#1E3553] shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="text-base font-bold text-white mb-1">
                Explore an HR Workflow POC
              </h4>
              <p className="text-xs text-slate-300">
                Validate resume screening or scheduling workflows in a single requisition cycle.
              </p>
            </div>
            <Button
              variant="primary"
