...
export function SalesWorkforcePage() {
  const { navigate } = useRouter();
  const data = WORKFORCE_SOLUTIONS.find(s => s.id === 'sales') || WORKFORCE_SOLUTIONS[1];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
          ...
          <div className="p-6 rounded-xl bg-[#0D1B2A] border border-teal-500/40 shadow-xl">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Coordinated sales agents handle prospecting research, contact verification, and CRM logging while empowering sales reps with pre-call executive intelligence and message approval controls.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-amber-200/90 leading-relaxed mb-4">
                To protect customer relationships and brand integrity, the following commercial actions require sales representative or manager authorization:
              </p>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            <span className="text-xs font-bold uppercase tracking-wider text-teal-400 font-mono block mb-1">
              Sales Execution Sequence
            </span>
            <h3 className="text-2xl font-bold text-white">
              10-Stage Coordinated Sales Workflow
            </h3>
          </div>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              9 Specialized Sales & Intelligence Agents
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
          <div className="lg:col-span-6 bg-[#0D1B2A] p-6 rounded-2xl border border-[#1E3553] shadow-xl">
            <h4 className="text-sm font-bold uppercase tracking-wider text-white mb-3 flex items-center gap-2 font-mono">
              ...
              Supported CRM & Sales Connectors
            </h4>
          ...
          <div className="lg:col-span-6 bg-[#0D1B2A] text-white p-6 rounded-2xl border border-[#1E3553] shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="text-base font-bold text-white mb-1">
                Explore a Sales Intelligence POC
              </h4>
              <p className="text-xs text-slate-300">
                Test automated lead research and CRM synchronization for your target territory.
              </p>
            </div>
            <Button
              variant="primary"
