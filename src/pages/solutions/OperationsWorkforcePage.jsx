...
export function OperationsWorkforcePage() {
  const { navigate } = useRouter();
  const data = WORKFORCE_SOLUTIONS.find(s => s.id === 'operations') || WORKFORCE_SOLUTIONS[5];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
          ...
          <div className="p-6 rounded-xl bg-[#0D1B2A] border border-teal-500/40 shadow-xl">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Coordinated operational agents validate incoming payloads, execute stateful transactional steps across legacy APIs, and isolate schema anomalies for quick human resolution.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-white mt-1 mb-2">
                Mandatory Operational Sign-Off Gates
              </h3>
              <p className="text-sm text-amber-200/90 leading-relaxed mb-4">
                To prevent unintended data mutations across production databases, the following actions require explicit operations engineer authorization:
              </p>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              7-Stage Automated Operational Workflow
            </h3>
          </div>
        ...
        <div className="bg-[#0D1B2A] rounded-2xl border border-[#1E3553] p-8 shadow-2xl mb-12 text-left">
          <div className="mb-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              6 Specialized Operational Agents
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
          <div className="lg:col-span-6 bg-[#0D1B2A] p-6 rounded-2xl border border-[#1E3553] shadow-xl">
            <h4 className="text-sm font-bold uppercase tracking-wider text-white mb-3 flex items-center gap-2 font-mono">
              ...
              Supported Database & Event Integrations
            </h4>
          ...
          <div className="lg:col-span-6 bg-[#0D1B2A] text-white p-6 rounded-2xl border border-[#1E3553] shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="text-base font-bold text-white mb-1">
                Explore an Operations POC
              </h4>
              <p className="text-xs text-slate-300">
                Validate automated data ingestion and validation pipelines.
              </p>
            </div>
            <Button
              variant="primary"
